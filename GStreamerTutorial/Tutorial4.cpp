...
Tutorial4::Tutorial4(int argc, char **argv)
{
	this->argc = argc;
	this->argv = argv;
}
...
int Tutorial4::init()
{
	...
	/* Set the URI to play */
	g_object_set(data.playbin, "uri", "http://dl3.webmfiles.org/big-buck-bunny_trailer.webm", NULL);
...
void Tutorial4::handle_message(CustomData *data, GstMessage *msg) {
	GError *err;
	gchar *debug_info;
